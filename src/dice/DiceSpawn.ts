...
import { presetForShape } from '../core-engine/wasm/physicsPresets.js';
 ...
 */
export const spawnObjects = (scene: any, world: any, config: any = null) => {
...
export const replaceDiceSet = (scene: any, world: any, specs: any) => {
    clearDice(scene, world);
    spawnObjects(scene, world, specs);
};

export const clearDice = (scene: any, _world: any) => {
...
export const updateDiceSet = (scene: any, world: any, targetCounts: any) => {
...
>>>>>>> origin/main:src/dice/DiceSpawn.js
