...
class TavernEnvironment extends Scene {
    ...
    async load() {
        ...
        const smallLightMat = new MeshLambertMaterial({
            color: 0x000000,
            emissive: 0xffaa44,
    ...
    dispose() {
        ...
        this.traverse((object) => {
            ...
            if (mesh.isMesh) {
                ...
                if (mat.map) resources.add(mat.map);
                if (mat.bumpMap) resources.add(mat.bumpMap);
                if (mat.roughnessMap) resources.add(mat.roughnessMap);
                if (mat.emissiveMap) resources.add(mat.emissiveMap);
            }
        });
